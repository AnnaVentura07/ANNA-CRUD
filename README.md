...
Códigos de Resposta
200/201 (Sucesso): A solicitação foi atendida com sucesso.

204 (Sem Conteúdo): A atualização ou exclusão funcionou corretamente.

404 (Não Encontrado): O ID informado não existe no banco.
